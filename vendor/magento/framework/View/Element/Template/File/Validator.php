...
class Validator
{
    ...
    protected function isPathInDirectories($path, $directories)
    {
		...
		# 2026-09-23 Dmitrii Fediuk https://github.com/dmitrii-fediuk
		# 1) "Adapt the website to Windows-based servers": https://github.com/tactical-expressions/m/issues/1
		...
		foreach ($directories as $directory) {
			if (
				...
				&& 0 === strpos(
					$realPath
					,!$isWin ? $directory : str_replace('/', DIRECTORY_SEPARATOR, $directory)
				)
			) {
				return true;
			}
