    ...
    $.widget('mage.configurable', {
        ...
        _initializeOptions: function () {
            var options = this.options,
                ...
                //TACX-100 Fix issue with configurable options not being selectable when user clicks at to cart from category page
                priceBoxOptions = this._getPriceBoxElement().priceBox().priceBox('option', 'openOnFocus', true).priceConfig || null;
