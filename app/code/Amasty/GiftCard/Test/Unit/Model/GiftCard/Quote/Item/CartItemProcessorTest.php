...
class CartItemProcessorTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        if (method_exists(ProductOptionExtension::class, 'getAmGiftcardOptions')) {
            $this->extensionAttributes = $this->createMock(ProductOptionExtension::class);
        } else {
            $this->extensionAttributes = $this->getMockBuilder(ProductOptionExtension::class)
                ->addMethods(['getAmGiftcardOptions', 'setAmGiftcardOptions'])
                ->getMock();
        }
