...
class GiftCardBalanceChangeNotifier implements GiftCardNotifierInterface
{
    ...
    public function notify(
        ...
        if (!$this->sender->isNeedSend(SmsConfigProvider::SMS_CHANGE_BALANCE_NOTIFICATION_ENABLE, $storeId)
        ...
        $configMessage = $this->smsConfigProvider->getSmsChangeBalanceNotificationTemplate($storeId);
        $dltid = $this->smsConfigProvider->getSmsChangeBalanceNotificationDltid($storeId);
