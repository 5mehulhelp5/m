...
class MainContent extends AbstractEntity
{
    ...
    public function __construct(
		...
		\Codazon\ThemeLayoutPro\Model\MainContentFactory $modelFactory,
        $data = []
    ) {
    ...
    {
        $this->_read = 'codazon_maincontent_read';
        $this->_write = 'codazon_maincontent_write';
    }
    
    public function getEntityType()
    {
        if(empty($this->_type)) {
            $this->setType(\Codazon\ThemeLayoutPro\Model\MainContent::ENTITY);
        }
    ...
    {
        return ['is_active', 'identifier', 'variables', 'custom_fields', 'parent'];
    }
    ...
    {
        return 'Codazon\ThemeLayoutPro\Model\Eav\Attribute';
    }
