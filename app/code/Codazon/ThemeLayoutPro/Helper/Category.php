...
class Category extends AbstractHelper
{
    ...
    public function __construct(
        ...
        \Magento\Catalog\Model\ResourceModel\Category\FlatFactory $categoryFlatFactory,
        ...
        $this->_categoryFlatFactory = $categoryFlatFactory;
        $this->_storeManager = $storeManager;
        $this->_dataCollectionFactory = $dataCollectionFactory;
        $this->categoryRepository = $categoryRepository;
        $this->categoryFlatState = $categoryFlatState;
        
        $this->categoryResource = \Magento\Framework\App\ObjectManager::getInstance()->get('Magento\Catalog\Model\ResourceModel\Category');
    ...
    public function getCategoriesByParentId($parent, $sorted = false, $asCollection = false, $toLoad = true)
    {
        ...
        // if(!$this->categoryFlatState->isFlatEnabled()){
            // $category = $this->_categoryFactory->create();
        // }else{
            // $category = $this->_categoryFlatFactory->create();
        // }
        ...
        $storeCategories = $this->categoryResource->getCategories($parent, $recursionLevel, $sorted, $asCollection, $toLoad);
