...
namespace Codazon\Lookbookpro\Model\LookbookCategory;

use Codazon\Lookbookpro\Model\ResourceModel\LookbookCategory\CollectionFactory as CollectionFactory;
...
{   
    ...
    protected $_entityTypeCode = 'cdzlookbook_category';
	...
	public function getData()
    {
        ...
        $data = $this->dataPersistor->get('cdzlookbook_category');
        if (!empty($data)) {
            $item = $this->collection->getNewEmptyItem();
            $item->setData($data);
            $this->loadedData[$item->getId()] = $item->getData();
            $this->dataPersistor->clear('cdzlookbook_category');
        }
        return $this->loadedData;
    }
    ...
    {
        $item = $this->registry->registry('lookbookpro_cdzlookbook_category');
        if ($item) {
            return $item;
        }
