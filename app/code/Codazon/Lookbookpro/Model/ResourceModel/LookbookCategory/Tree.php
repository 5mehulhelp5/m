...
class Tree extends Dbp
{
    ...
    public function __construct(
        \Codazon\Lookbookpro\Model\ResourceModel\LookbookCategory $lookbookCategory,
        ...
        parent::__construct(
            $resource->getConnection('cdzlookbook_category'),
            $resource->getTableName('cdzlookbook_category_entity'),
            [
    ...
    protected function _getDefaultCollection($sorted = false)
    {
        ...
        $attributes = $this->_attributeConfig->getAttributeNames('cdzlookbook_category');
    ...
    {
        $this->_cache->clean([\Codazon\Lookbookpro\Model\LookbookCategory::CACHE_TAG]);
        return $this;
    }
    ...
    protected function _createCollectionDataSelect($sorted = true, $optionalAttributes = [])
    {
        ...
        $categoriesTable = $this->_coreResource->getTableName('cdzlookbook_category_entity');
        $categoriesProductsTable = $this->_coreResource->getTableName('cdzlookbook_category_lookbook');
