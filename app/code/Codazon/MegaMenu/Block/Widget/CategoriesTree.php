...
class CategoriesTree extends Template implements IdentityInterface
{
     ...
     * @param array $data
     */
    protected $ulHtmlClass = 'groupmenu-drop';
    
    protected $liHtmlClass = '';
    ...
    public function assignUlHtmlClass($class)
    {
        $this->ulHtmlClass = $class;
        return $this;
    }
    
    public function assignLiHtmlClass($class)
    {
        $this->liHtmlClass = $class;
        return $this;
    }
    ...
    protected function _addSubMenu($child, $childLevel, $childrenWrapClass, $limit)
    {
        ...
        $html .= '<ul class="level' . $childLevel . ' '. $this->ulHtmlClass .'">';
