...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getBrandPlaceholderPath()
    {
        if ($this->_brandPlaceholder === null) {
            $thumbnail = $this->_scopeConfig->getValue('codazon_shopbybrand/general/brand_placeholder', 'store', $this->_storeId);
            $this->_brandPlaceholder = $thumbnail ? 'codazon/brand/placeholder/'.$thumbnail : 'codazon/brand/placeholder_thumbnail.jpg';
        }
        return $this->_brandPlaceholder;
    }
    ...
    public function getBrandImage($brand, $type = 'brand_thumbnail', $options = [])
    {
        ...
        if ($type === 'brand_thumbnail') {
            if (!$brandThumb) {
                $brandThumb = $this->getBrandPlaceholderPath();
            }
        }
		if ($brandThumb) {
