 ...
 */
class Moveallfromcart extends \Magento\Framework\App\Action\Action
{
    /**
    ...
    public function execute()
    {
        ...
        try {
            ...
            if (empty($items)) {
                $postResult['message'] = __('Your cart is empty.');
            } else {
                ...
                $wishlist->save();     
                $postResult['message'] = __('All items have been moved to your wish list.');
