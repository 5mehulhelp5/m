 ...
 */
namespace Webkul\QuickPayForOrder\Block\Adminhtml\Order;
...
class Create extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->buttonList->update('save', 'class', 'primary quick_pay_order_main_submit ');
        ...
        $addButtonProps = [
            'id' => 'quick_pay_order',
            'label' => __('Send Order Link'),
            'class' => 'primary quick_pay_order wk-hidden',
            'style' => 'display:none'
        ];
