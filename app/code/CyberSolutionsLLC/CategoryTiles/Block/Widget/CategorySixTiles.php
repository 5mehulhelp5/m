...
class CategorySixTiles extends Template implements BlockInterface
{
    protected $_template = 'CyberSolutionsLLC_CategoryTiles::widget/category_six_tiles.phtml';
    ...
    {
        return (string) $this->getData('heading') ?: 'Popular Colors';
    }
}
